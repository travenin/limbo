...
use crate::function::{AggFunc, FuncCtx, MathFunc, ScalarFunc};
...
fn exec_math_unary(reg: &OwnedValue, function: &MathFunc) -> OwnedValue {
    ...
    match function {
        ...
        _ => unreachable!("Unexpected unary mathematical function {:?}", function),
    }
}
...
fn exec_math_binary(lhs: &OwnedValue, rhs: &OwnedValue, function: &MathFunc) -> OwnedValue {
    ...
    match function {
        ...
        _ => unreachable!("Unexpected binary mathematical function {:?}", function),
    }
}
